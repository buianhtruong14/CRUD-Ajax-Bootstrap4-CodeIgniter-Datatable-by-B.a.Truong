							...
							<div class="modal-body">
								<form action="" method="post" id="form">
									<div class="form-group">
										...
										<input type="text" id="ten_lop" class="form-control">
									</div>
									<div class="form-group">
										<label for="">Sĩ Số</label>
										<input type="text" id="si_so" class="form-control">
									</div>
									<div class="form-group">
										<label for="">Lớp Trưởng</label>
										<input type="text" id="lop_truong" class="form-control">
									</div>
									<div class="form-group">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="" method="post" id="edit_form">
									...
									<div class="form-group">
										<label for="">Tên Lớp</label>
										<input type="text" id="edit_ten_lop" class="form-control">
									</div>
									<div class="form-group">
										<label for="">Sĩ Số</label>
										<input type="text" id="edit_si_so" class="form-control">
									</div>
									<div class="form-group">
										<label for="">Lớp Trưởng</label>
										<input type="text" id="edit_lop_truong" class="form-control">
									</div>
									<div class="form-group">
										<label for="">Giáo Viên Chủ Nhiệm</label>
     ...
     <script type="text/javascript" language="javascript">
          $(document).ready(function() {
               var dataTable = $('#user_data').DataTable({
                    ...
                    "order": [],
                    "ajax": {
                         url: "<?php echo base_url() . 'lop/fetch_user'; ?>",
                         type: "POST"
                    },
                    "columnDefs": [{
                         "targets": [0, 3, 4],
          ...
          $(document).on("click", "#add", function(e) {
               ...
               var si_so = $("#si_so").val();
               var lop_truong = $("#lop_truong").val();
               var gv_day = $("#gv_day").val();
               if (ten_lop == "" || si_so == "" || lop_truong == "" || gv_day == "") {
                    alert("all field is required");
               } else {
                    $.ajax({
                         url: "<?php echo base_url() . 'lop/insert'; ?>",
                         type: "post",
                         dataType: "json",
                         data: {
                              ten_lop: ten_lop,
               ...
               if (del_id == "") {
                    ...
                    swalWithBootstrapButtons.fire({
                         ...
                         if (result.value) {
                              ...
                              $.ajax({
                                   url: "<?php echo base_url() . 'lop/delete'; ?>",
                                   type: "post",
                                   dataType: "json",
                                   data: {
                                        del_id: del_id
          ...
          $(document).on("click", "#edit", function(e) {
               ...
               if (edit_id == "") {
                    ...
                    $.ajax({
                         url: "<?php echo base_url() . 'lop/edit'; ?>",
                         type: "post",
                         dataType: "json",
                         data: {
                              edit_id: edit_id
                         ...
                         success: function(data) {
                              if (data.responce == "success") {
                                   ...
                                   $("#edit_ten_lop").val(data.post.ten_lop);
                                   $("#edit_si_so").val(data.post.si_so);
                                   $("#edit_lop_truong").val(data.post.lop_truong);
          ...
          $(document).on("click", "#update", function(e) {
               ...
               var edit_ten_lop = $("#edit_ten_lop").val();
               var edit_si_so = $("#edit_si_so").val();
               var edit_lop_truong = $("#edit_lop_truong").val();
               var edit_gv_day = $("#edit_gv_day").val();

               if (edit_id == "" || edit_ten_lop == "" || edit_si_so == "" || edit_lop_truong == "" ||
                    edit_gv_day == "") {
                    alert("all field is required");
               } else {

                    $.ajax({
                         url: "<?php echo base_url() . 'lop/update'; ?>",
                         type: "post",
                         dataType: "json",
                         data: {
                              edit_id: edit_id,
                              edit_ten_lop: edit_ten_lop,
                              edit_si_so: edit_si_so,
                              edit_lop_truong: edit_lop_truong,
