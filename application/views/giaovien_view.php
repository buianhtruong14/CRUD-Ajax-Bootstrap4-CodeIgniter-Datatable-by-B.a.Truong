     ...
     <script type="text/javascript" language="javascript">
          $(document).ready(function() {
               var dataTable = $('#user_data').DataTable({
                    ...
                    "order": [],
                    "ajax": {
                         url: "<?php echo base_url() . 'giaovien/fetch_user'; ?>",
                         type: "POST"
                    },
                    "columnDefs": [{
                         "targets": [0, 3, 4],
          ...
          $(document).on("click", "#add", function(e) {
               ...
               if (ten_gv == "" || ngaysinh_gv == "" || lop_day == "" || mon_day == "") {
                    ...
                    $.ajax({
                         url: "<?php echo base_url() . 'giaovien/insert'; ?>",
                         type: "post",
                         dataType: "json",
                         data: {
                              ten_gv: ten_gv,
               ...
               if (del_id == "") {
                    ...
                    swalWithBootstrapButtons.fire({
                         ...
                         if (result.value) {
                              ...
                              $.ajax({
                                   url: "<?php echo base_url() . 'giaovien/delete'; ?>",
                                   type: "post",
                                   dataType: "json",
                                   data: {
                                        del_id: del_id
          ...
          $(document).on("click", "#edit", function(e) {
               ...
               if (edit_id == "") {
                    ...
                    $.ajax({
                         url: "<?php echo base_url() . 'giaovien/edit'; ?>",
                         type: "post",
                         dataType: "json",
                         data: {
                              edit_id: edit_id
          ...
          $(document).on("click", "#update", function(e) {
               ...
               if (edit_id == "" || edit_ten_gv == "" || edit_ngaysinh_gv == "" || edit_lop_day == "" ||
                    ...
                    $.ajax({
                         url: "<?php echo base_url() . 'giaovien/update'; ?>",
                         type: "post",
                         dataType: "json",
                         data: {
                              edit_id: edit_id,
